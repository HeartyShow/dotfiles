...
export CFORG="bigdata-mlfoundation"
cflogin(){cf login -a $CFURL -o $CFORG -u $EMAIL -s $1}

alias cfloginsapitfox="cf login -a $CFURL -o sapit-core-dev-fox -u $EMAIL -s data-foundation-cockpit"
alias cfloginsapitcheetah="cf login -a $CFURL -o sapit-core-test-cheetah -u $EMAIL -s data-foundation-cockpit"
alias cfloginsapitlion="cf login -a $CFURL -o sapit-core-prod-lion -u $EMAIL -s data-foundation-cockpit"

# Brew
alias brewdump="brew bundle dump --force --file=~/Brewfile --brews --cask --tap --whalebrew"
