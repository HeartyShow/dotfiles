...
vim.keymap.set('n', '<leader>fs', builtin.find_files, { desc = 'Find file in current project' })
...
vim.keymap.set("n", "<space>fb", ":Telescope file_browser<CR>", { desc = 'Find in current project' })

require("telescope").load_extension("aerial")
vim.keymap.set('n', '<leader>o', ':Telescope aerial<CR>', { desc = 'Find in current project' })
